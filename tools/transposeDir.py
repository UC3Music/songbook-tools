...
def process( stringToProcess, processed ):
    ...
    afterSplit = re.split("  |-|!|\.\.\.|\.\.|: |high|open|bass|riff|notes|m6|7sus2", stringToProcess, 1)  # 3rd parameter is maxsplit # Also works with single space, do this to catch faulty txt.
